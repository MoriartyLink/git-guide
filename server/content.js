...
export const commandResponses = {
  help: {
    lines: [
      ...
      "  ssh-add           load a key into ssh-agent",
      "  ssh -T            test GitHub SSH",
      "  gh issue list     find GitHub issues",
      "  gh issue create   create an issue",
      "  gh issue comment  claim or discuss an issue",
      "  gh pr create      open a pull request",
      "  gh pr checks      inspect pull request CI",
      "  gh project list   find GitHub Projects",
      "  gh project item-add / item-list",
