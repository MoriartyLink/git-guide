/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=sandbox/wrangler.jsonc sandbox/worker-configuration.d.ts` (hash: 76420d143eac57ba2d6629f46a97da5f)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173,https://git-guide-ruby.vercel.app";
	SANDBOX_TRANSPORT: "rpc";
	SUPABASE_URL: "https://hiedkdrurpjriccflyph.supabase.co";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "SANDBOX_TRANSPORT" | "SUPABASE_URL" | "TERMINAL_TICKET_SECRET">> {}
}
